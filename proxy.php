...
switch ($method) {
  case "POST":
    /* @param unset cors and method POST values used by only this proxy and not needed by called API endpoint */
  ...
  case "GET":
    /* @param unset cors and method GET values used by only this proxy and not needed by called API endpoint */
    if (isset($is_json_request) && $is_json_request == true) {
